...
export default class LevelShow extends Component {
  state = {
    pageX: 0,
    index: 1, // 会员的index
    animationData: {}
    ...
    return (
      <View className='show-box'>
        ...
        <View className={`level-details details${index}`} onTouchStart={this.TouchStart} onTouchEnd={this.TouchEnd} animation={this.state.animationData}>
          ...
          <View className='text'>同时满足以下3个条件：1. 建群：①本人所建立群人数达200人；②直属创客不低于5人，总创客数不低于20人2.拓展商家3家   3. 活跃值达到1000；活跃值：1元销售佣金=1个活跃值；活跃值构成：1.本人建群：200分封顶 2.直属创客建群：200分封顶/群</View>
        </View>
      </View>
    )
  }
