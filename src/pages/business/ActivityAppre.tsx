            ...
            <View className="group-purchase bcfff" key={item.name}>
              ...
              <View className="image-list" style={{ position: "relative", marginBottom: "5px" }}>
                ...
                <View className="img" style={{ width: "100%" }}   >
                  <View className="box_left">
                    <View className="box_left_price">￥ <View className="_price">{item.init_money}</View></View>
              ...
              <View className="ft ">
                <View className="flex center">
                  ...
                  <Button className="btn-go" style={{ width: "104px", height: "33px" }} onClick={this.gotoAppreciation.bind(this, item.youhui_id, item.gift_id, item.activity_id)}>立刻增值</Button>
                </View>
              </View>
            </View>
              ...
              <View className="image-list" style={{ position: "relative", marginBottom: "5px" }}>
                {
                  this.state.activity_appre[0].gift_pic == "" ? <Image className="backg-image" src={"http://tmwl.oss-cn-shenzhen.aliyuncs.com/front/bMGJKGX2JcKWbs8JEypeiB7CAbd4wAz4.png"} /> :
                    <Image className="backg-image" src={"http://tmwl.oss-cn-shenzhen.aliyuncs.com/front/andhNY3XKEWrW8nYBK5pyAptaJWeJz68.png"} />
                }
                <View className="img" style={{ width: "100%" }}   >
                  <View className="box_left">
                    <View className="box_left_price">￥ <View className="_price">{this.state.activity_appre[0].init_money}</View></View>
                    <View className="box_left_return">最高可抵{this.state.activity_appre[0].return_money}元</View>
                  </View>
                  <View className="box_center">
                    <View className="present"><View className="present_text">{this.state.activity_appre[0].name}</View></View>
                    <View className="present_recommend">{this.state.activity_appre[0].gift_desc}</View>
                  </View>

                  <View className="box_right" style={{ overflow: "hidden" }}>
                    <Image className="image" src={this.state.activity_appre[0].gift_pic} style={{ width: "100%", height: "100%" }} />
                  </View>
                </View>
              </View>
              <View className="ft ">
                <View className="flex center">
                  ...
                  <Button className="btn-go" style={{ width: "104px", height: "33px" }} onClick={this.gotoAppreciation.bind(this, this.state.activity_appre[0].youhui_id, this.state.activity_appre[0].gift_id, this.state.activity_appre[0].activity_id)}>立刻增值</Button>
                </View>
              </View>
            </View>
        }
